...
xwallpaper --maximize Pictures/wall/TheDragonSlayer.png
#save my eyes
#redshift -l 23.6943:90.3444 &
redshift -O 4500 &
#python script for slstatus football matchday indicator
python ~/atiqxe/scripts/real_fix_indicator/getData.py
